...
INCLUDES=(
  "${ROOT_DIR}/includes/01-document_system.sh"
  "${ROOT_DIR}/includes/02-os_updates.sh"
  "${ROOT_DIR}/includes/03-user_auditing.sh"
  "${ROOT_DIR}/includes/04-account_policy.sh"
  "${ROOT_DIR}/includes/05-local_policy.sh"
  "${ROOT_DIR}/includes/06-defensive_countermeasures.sh"
  "${ROOT_DIR}/includes/07-uncategorized_os.sh"
  "${ROOT_DIR}/includes/08-service_auditing.sh"
  "${ROOT_DIR}/includes/09-application_updates.sh"
  "${ROOT_DIR}/includes/10-prohibited_files.sh"
  "${ROOT_DIR}/includes/11-unwanted_software.sh"
  "${ROOT_DIR}/includes/12-malware.sh"
  "${ROOT_DIR}/includes/13-application_security.sh"
)
